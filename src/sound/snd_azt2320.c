...
azt2320_init(UNUSED(const device_t *info))
{
    ...
    if (azt2320->sb->opl_enabled)
        fm_driver_get(FM_YMF262 | FM_OPL3TIMER, &azt2320->sb->opl, music_add_handler(sb_get_music_buffer_sbpro, azt2320->sb));
    ...
    azt2320->ad1848.source = sound_add_handler(azt2320_get_buffer, azt2320);
    azt2320->sb->dsp.source = sound_add_handler(azt2320_get_sbpro_buffer, azt2320);
