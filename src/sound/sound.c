        ...
        switch (source->format) {
            case SOUND_U8:
                for (int i = 0; i < (sizeof(intermediate) / sizeof(intermediate[0])); i++)
                    intermediate[i] = sound_convert_u8(temp.u8[i]);
                break;
            ...
            case SOUND_FLOAT32:
                for (int i = 0; i < (sizeof(intermediate) / sizeof(intermediate[0])); i++)
                    intermediate[i] = sound_convert_f32(temp.f[i]);
                break;

            case SOUND_MULAW:
                for (int i = 0; i < (sizeof(intermediate) / sizeof(intermediate[0])); i++)
                    intermediate[i] = sound_convert_mulaw(temp.u8[i]);
                break;

            case SOUND_ALAW:
                for (int i = 0; i < (sizeof(intermediate) / sizeof(intermediate[0])); i++)
                    intermediate[i] = sound_convert_alaw(temp.u8[i]);
                break;
